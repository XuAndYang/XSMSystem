...
<body class="index">
	...
	<div class="container">
		<div class="logo">
			<a href="./index.html">商品销售信息管理系统</a>
		</div>
		<div class="left_open">
		...
		<ul class="layui-nav right" lay-filter="">
			...
			<li class="layui-nav-item to-index"><a href="./welcome.html">关于更多</a></li>
		</ul>
	</div>
	<!-- 顶部结束 -->
	<!-- 中部开始 -->
					...
					<li><c:if test="${menu.pId==1}">
					 <a href="javascript:;"> <i class="iconfont left-nav-li"
                      ...
                      <c:forEach items="${permissionList }" var="permission">
						...
						<li><a onclick="xadmin.add_tab('${permission.permissionName}','<%=basePath%>${permission.permissionUrl }')">
							<i class="iconfont">&#xe6a7;</i> <cite>${permission.permissionName}</cite>
							</a>
						</li>
						</c:forEach>
						</c:if>
