                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                 <button type="button" class="layui-btn"><i class="layui-icon"></i>销售员工号</button>
                                ...
                                <div class="layui-inline layui-show-xs-block" style="margin-left:30px">
                                 ...
                                 <button type="button" class="layui-btn"><i class="layui-icon"></i>考勤时间</button>
                                
                                <div class="layui-inline layui-show-xs-block" style="margin-left:30px">
                                    <input type="text" name="time_year"  placeholder="请输入年份" autocomplete="off" class="layui-input" >
                                </div>
                                
                                  <div class="layui-inline layui-show-xs-block" style="margin-left:30px">
                                    <input type="text" name="time_month"  placeholder="请输入月份" autocomplete="off" class="layui-input" >
                                </div>
                               
                                <div class="layui-inline layui-show-xs-block">
                                
                                 <button class="layui-btn"  lay-submit="" onclick="javascript:this.form.action='<%=basePath%>statisticsInfoController/searchUser.do';"  lay-filter="sreach" >
