...
<head>
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>userController/add.do">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="login_name" name="login_name" required="" lay-verify="login_name" autocomplete="off" class="layui-input"></div>
                    </div>
