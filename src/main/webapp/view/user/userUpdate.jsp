                ...
                <input type="hidden" name="login_name" value="${user.loginName }">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="name" name="name" value="${user.name }" required="" lay-verify="name" autocomplete="off" class="layui-input"></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="password" id="password" name="password" required=""  value="${user.password }" lay-verify="password" autocomplete="off" class="layui-input" ></div>
