...
<head>
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>goodsInfoController/goodsupdate.do">
                <input type="hidden" name="goods_id" value="${goodsInfo.goodsId }">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="name" name="goods_name" value="${goodsInfo.goodsName}" required="" lay-verify="name" autocomplete="off" class="layui-input"></div>
                        <div class="layui-form-mid layui-word-aux">
                            <span class="x-red">*</span>请输入完整</div></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <select name="goods_type">
							<option >${goodsInfo.goodsType}</option>
                        ...
                        <div class="layui-form-mid layui-word-aux"><span class="x-red">*</span>请明确分类</div></div>
                    <div class="layui-form-item">
                        <label for="name2" class="layui-form-label">
                            <span class="x-red">*</span>单价</label>
                        <div class="layui-input-inline">
                            <input type="text" id="name2" name="goods_price" required=""  value="${goodsInfo.goodsPrice}" lay-verify="name" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="name3" class="layui-form-label">
                            <span class="x-red">*</span>入存数量</label>
                        <div class="layui-input-inline">
