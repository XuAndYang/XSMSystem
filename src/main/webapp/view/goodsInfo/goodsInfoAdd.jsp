                ...
                <form class="layui-form" action="<%=basePath%>goodsInfoController/add.do">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="name" name="goods_name" required=""  autocomplete="off" class="layui-input"></div>
                    ...
                    <div class="layui-form-item">
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="repassword" name="remaining_number" required=""  autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
