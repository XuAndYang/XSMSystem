                        ...
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="goodsInfo_search"  placeholder="请输入商品ID或商品名称" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                                    <button class="layui-btn"  lay-submit="" lay-filter="sreach" onclick="javascript:this.form.action='<%=basePath%>goodsInfoController/searchGoodsInfo.do'"><i class="layui-icon">&#xe615;</i></button>
                                </div>
                            </form>
                        </div>
                        <div class="layui-card-header">
                            <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button>
                            <button class="layui-btn" onclick="xadmin.open('添加商品','<%=basePath%>goodsInfoController/addUI.do',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <c:forEach items="${goodsInfoList }" var="goodsInfo">
                                  ...
                                  <tr>
                                    ...
                                    <td>${goodsInfo.goodsType }</td>
                                    <td>${goodsInfo.goodsPrice }</td>
                                    <td>${goodsInfo.totalNumber }</td>
									<td>${goodsInfo.remainingNumber }</td>
                                    <td class="td-manage">
