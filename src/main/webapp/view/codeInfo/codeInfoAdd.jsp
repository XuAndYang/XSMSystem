                ...
                <form class="layui-form" action="<%=basePath%>codeInfoController/add.do">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="name" name="goods_id" required=""  autocomplete="off" class="layui-input" /></div>
                       </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="repassword" name="goods_code" required=""  autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
