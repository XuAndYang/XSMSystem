                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block" style="margin-left:30px">
                                    <input type="text" name="permission_search"  placeholder="请输入权限名称" autocomplete="off" class="layui-input" >
                                </div>
                               
                                <div class="layui-inline layui-show-xs-block">
                                
                                 <button class="layui-btn"  lay-submit="" onclick="javascript:this.form.action='<%=basePath%>permissionController/searchPermission.do';"  lay-filter="sreach" >
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','<%=basePath%>permissionController/addUI.do',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
