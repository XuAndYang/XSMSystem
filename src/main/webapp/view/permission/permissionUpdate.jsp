...
<head>
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>permissionController/update.do">
                <input type="hidden" name="permission_id" value="${p.permissionId }">
							...
							<c:forEach items="${permissionList }" var="per">
								<c:if test="${per.permissionId == p.pId }" var="anth">
									<option id="${per.permissionId }" value="${per.permissionId }"
										selected="selected">${per.permissionName }</option>
								</c:if>
								
								<c:if test="${per.permissionId != p.pId }" var="anth">
									<option id="${per.permissionId }" value="${per.permissionId }">${per.permissionName }</option>
								</c:if>
							</c:forEach>
						</select>
