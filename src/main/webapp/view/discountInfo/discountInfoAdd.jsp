...
<head>
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>discountInfoController/add.do">
                    ...
                    <div class="layui-form-item">
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="login_name2" name="discount" required="" lay-verify="login_name2" autocomplete="off" class="layui-input"></div>
                    </div>
