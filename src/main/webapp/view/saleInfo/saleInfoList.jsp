                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body layui-table-body layui-table-main">
                            <table class="layui-table layui-form">
                                ...
                                <c:forEach items="${saleInfoList}" var="saleInfo">
                               
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="id" value="1"   lay-skin="primary"> 
                                    </td>
                                    <td>${saleInfo.saleId}</td>
                                    <td>${saleInfo.vipName}</td>
                                    <td>${saleInfo.goodsName}</td>
                                    <td>${saleInfo.saleNumber}</td>
                                    <td>${saleInfo.unitPrice}</td>
									<td>${saleInfo.discountPrice}</td>
                                    <td>${saleInfo.consumeMoney}</td>
                                    <td> <fmt:formatDate value="${saleInfo.time }" pattern='yyyy-MM-dd HH:mm:ss'/></td>
