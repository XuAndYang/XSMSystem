                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block" style="margin-left:30px">
                                    <input type="text" name="salesmanInfo_search"  placeholder="请输入员工工号或姓名" autocomplete="off" class="layui-input" >
                                </div>
                               
                                <div class="layui-inline layui-show-xs-block">
                                
                                 <button class="layui-btn"  lay-submit="" onclick="javascript:this.form.action='<%=basePath%>salesmanInfoController/searchSalesmanInfo.do';"  lay-filter="sreach" >
                        ...
                        <div class="layui-card-body layui-table-body layui-table-main">
                            <table class="layui-table layui-form" >
                                ...
                                <tbody>
                                <c:forEach items="${salesmanInfoList }" var="salesmanInfo">
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="id" value="1"   lay-skin="primary"> 
                                    </td>
                                    <td>${salesmanInfo.salesmanId }</td>
                                    <td>${salesmanInfo.salesmanName }</td>
                                    <td>${salesmanInfo.salesmanSex }</td>
                                    <td>${salesmanInfo.salesmanAge }</td>
                                    <td>${salesmanInfo.salesmanTel }</td>
                                   <td><fmt:formatDate value="${salesmanInfo.joinTime }"
							          pattern="yyyy-MM-dd" />
                                    ...
                                    <td class="td-manage">
                                      ...
                                      <a href="<%=basePath%>salesmanInfoController/selectWorkInfo.do?salesmanId=${salesmanInfo.salesmanId}" title="查看考勤信息" >
                                        <i class="layui-icon layui-icon-read" style="margin-right: 40px ;font-size: 20px"></i>
                                      </a>
