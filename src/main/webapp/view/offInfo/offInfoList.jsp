                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block" style="margin-left:30px">
                                    <input type="text" name="offInfo_search"  placeholder="请输入员工号或姓名" autocomplete="off" class="layui-input" >
                                </div>
                               
                                <div class="layui-inline layui-show-xs-block">
                                
                                 <button class="layui-btn"  lay-submit="" onclick="javascript:this.form.action='<%=basePath%>offInfoController/searchOffInfo.do';"  lay-filter="sreach" >
                        ...
                        <div class="layui-card-body layui-table-body layui-table-main">
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                <c:forEach items="${offInfolist }" var="offInfo">
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="id" value="1"   lay-skin="primary"> 
                                    </td>
                                    <td>${offInfo.id }</td>
                                    <td>${offInfo.salesmanId }</td>
                                    <td>${offInfo.salesmanName }</td>
                                   <td><fmt:formatDate value="${offInfo.startTime }"
							          pattern="yyyy-MM-dd HH:mm:ss" />
                                    <td><fmt:formatDate value="${offInfo.endTime }"
							          pattern="yyyy-MM-dd HH:mm:ss" />
                                   <td>${offInfo.totalDays }</td>
                                    <td>${offInfo.reason}</td>
                                      ...
                                      <a title="删除"  href="<%=basePath%>offInfoController/deleteOffInfo.do?id=${offInfo.id}"  onclick="return del(1)">
