                ...
                <form class="layui-form" action="<%=basePath%>offInfoController/update.do">
                    ...
                    <div class="layui-form-item">
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="time1" name="start_time" value="<fmt:formatDate value='${offInfo.startTime}' type='date' pattern='yyyy-MM-dd HH:mm:ss'/>" required="" lay-verify="login_name2" autocomplete="off" class="layui-input" ></div>
                    </div>
