...
<head>
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>payoutInfoController/add.do">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="login_name1" name="payout_money" required="" lay-verify="login_name1" autocomplete="off" class="layui-input"></div>
                    </div>
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="name" name="account_number" required="" lay-verify="name" autocomplete="off" class="layui-input">
                            </div>
                        </div>
