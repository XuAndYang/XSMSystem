                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加角色','<%=basePath%>roleController/addUI.do',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                                ...
                                <c:forEach items="${roleList }" var="role">
                                  <tr>
                                    ...
                                    <td class="td-manage">
                                      ...
                                      <a onclick="xadmin.open('分配权限','',600,400)" title="分配权限" href="javascript:;">
                                        <i class="layui-icon" style="margin-right: 30px">&#xe631;</i>
                                      </a>
