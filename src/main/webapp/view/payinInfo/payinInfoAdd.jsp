...
<head>
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>payinInfoController/add.do">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="login_name1" name="account_number" required="" lay-verify="login_name1" autocomplete="off" class="layui-input"></div>
                    </div>
