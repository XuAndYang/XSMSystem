...
//删除指定用户信息
	...
	public String deleteUser(HttpServletRequest req, HttpServletResponse resp, HttpSession session,
			Model model,User user,@RequestParam(value="userId",required=false) String userIdStr
			) throws ServletException, IOException{
