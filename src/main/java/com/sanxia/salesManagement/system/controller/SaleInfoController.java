...
//显示订单信息列表
	...
	public String deleteGoodsInfo(HttpServletRequest req, HttpServletResponse resp, HttpSession session,
			Model model,GoodsInfo goodsInfo,@RequestParam(value="saleId",required=false) String saleIdStr
			) throws ServletException, IOException{
	...
	//增加销售订单信息
		...
		//删除指定信息
		@RequestMapping(value="deleteSaleInfo.do")
		public String deleteSaleInfo(HttpServletRequest req, HttpServletResponse resp, HttpSession session,
				Model model,User user,@RequestParam(value="saleId",required=false) String saleIdStr
				) throws ServletException, IOException{
...
//确认订单
				...
				public String updateStatus(HttpServletRequest req, HttpServletResponse resp, HttpSession session,
						Model model) throws ParseException{
					String saleIdStr= req.getParameter("saleId");
					int saleId=Integer.parseInt(saleIdStr);
					SaleInfo s=new SaleInfo();
